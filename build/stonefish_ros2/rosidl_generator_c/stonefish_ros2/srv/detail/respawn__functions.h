...
#ifndef STONEFISH_ROS2__SRV__DETAIL__RESPAWN__FUNCTIONS_H_
#define STONEFISH_ROS2__SRV__DETAIL__RESPAWN__FUNCTIONS_H_
...
/// Initialize srv/Respawn message.
/**
...
/// Create srv/Respawn message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stonefish_ros2__srv__Respawn_Request__init().
...
/// Destroy srv/Respawn message.
/**
 * It calls
 * stonefish_ros2__srv__Respawn_Request__fini()
...
/// Initialize array of srv/Respawn messages.
/**
...
/// Finalize array of srv/Respawn messages.
/**
 * It calls
 * stonefish_ros2__srv__Respawn_Request__fini()
...
/// Create array of srv/Respawn messages.
/**
 * It allocates the memory for the array and calls
 * stonefish_ros2__srv__Respawn_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Respawn messages.
/**
 * It calls
 * stonefish_ros2__srv__Respawn_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stonefish_ros2__srv__Respawn_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stonefish_ros2
...
/**
 * It calls
 * stonefish_ros2__srv__Respawn_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_stonefish_ros2
...
/**
 * It allocates the memory for the array and calls
 * stonefish_ros2__srv__Respawn_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stonefish_ros2
...
/**
 * It calls
 * stonefish_ros2__srv__Respawn_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // STONEFISH_ROS2__SRV__DETAIL__RESPAWN__FUNCTIONS_H_
