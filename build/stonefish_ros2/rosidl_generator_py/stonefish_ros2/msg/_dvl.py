...
class Metaclass_DVL(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from stonefish_ros2.msg import DVLBeam
...
class DVL(metaclass=Metaclass_DVL):
    ...
    _fields_and_field_types = {
        ...
        'altitude': 'double',
        'beams': 'sequence<stonefish_ros2/DVLBeam>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['stonefish_ros2', 'msg'], 'DVLBeam')),  # noqa: E501
    )
