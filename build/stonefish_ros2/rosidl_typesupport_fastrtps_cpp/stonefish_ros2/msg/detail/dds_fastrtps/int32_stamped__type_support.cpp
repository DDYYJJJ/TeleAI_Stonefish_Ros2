...
#include "stonefish_ros2/msg/detail/int32_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stonefish_ros2::msg::Int32Stamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stonefish_ros2::msg::Int32Stamped & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const stonefish_ros2::msg::Int32Stamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stonefish_ros2::msg::Int32Stamped *>(
    untyped_ros_message);
...
{
  return &stonefish_ros2::msg::typesupport_fastrtps_cpp::_Int32Stamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stonefish_ros2, msg, Int32Stamped)() {
  return &stonefish_ros2::msg::typesupport_fastrtps_cpp::_Int32Stamped__handle;
}
