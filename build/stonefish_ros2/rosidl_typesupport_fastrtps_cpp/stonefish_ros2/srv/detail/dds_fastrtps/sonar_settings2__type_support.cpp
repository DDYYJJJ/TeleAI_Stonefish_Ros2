...
#include "stonefish_ros2/srv/detail/sonar_settings2__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const stonefish_ros2::srv::SonarSettings2_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stonefish_ros2::srv::SonarSettings2_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SonarSettings2_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const stonefish_ros2::srv::SonarSettings2_Request *>(
...
static size_t _SonarSettings2_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SonarSettings2_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SonarSettings2_Request__callbacks = {
  "stonefish_ros2::srv",
...
static rosidl_message_type_support_t _SonarSettings2_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SonarSettings2_Request__callbacks,
...
{
  return &stonefish_ros2::srv::typesupport_fastrtps_cpp::_SonarSettings2_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const stonefish_ros2::srv::SonarSettings2_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stonefish_ros2::srv::SonarSettings2_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SonarSettings2_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const stonefish_ros2::srv::SonarSettings2_Response *>(
...
static size_t _SonarSettings2_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SonarSettings2_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SonarSettings2_Response__callbacks = {
  "stonefish_ros2::srv",
...
static rosidl_message_type_support_t _SonarSettings2_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SonarSettings2_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &stonefish_ros2::srv::typesupport_fastrtps_cpp::_SonarSettings2_Response__handle;
}
...
static service_type_support_callbacks_t _SonarSettings2__callbacks = {
  "stonefish_ros2::srv",
  "SonarSettings2",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stonefish_ros2, srv, SonarSettings2_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stonefish_ros2, srv, SonarSettings2_Response)(),
...
static rosidl_service_type_support_t _SonarSettings2__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SonarSettings2__callbacks,
...
{
  return &stonefish_ros2::srv::typesupport_fastrtps_cpp::_SonarSettings2__handle;
}
