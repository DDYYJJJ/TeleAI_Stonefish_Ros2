...
size_t stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__size_function__DVLBeam__beams(
...
const void * stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__get_const_function__DVLBeam__beams(
...
void * stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__get_function__DVLBeam__beams(
...
bool stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__resize_function__DVLBeam__beams(
...
static rosidl_typesupport_introspection_c__MessageMember stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__DVL_message_member_array[5] = {
  ...
  },
  {
    ...
    NULL,  // default value
    stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__size_function__DVLBeam__beams,  // size() function pointer
    stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__get_const_function__DVLBeam__beams,  // get_const(index) function pointer
    stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__get_function__DVLBeam__beams,  // get(index) function pointer
    stonefish_ros2__msg__DVL__rosidl_typesupport_introspection_c__resize_function__DVLBeam__beams  // resize(index) function pointer
  }
};
