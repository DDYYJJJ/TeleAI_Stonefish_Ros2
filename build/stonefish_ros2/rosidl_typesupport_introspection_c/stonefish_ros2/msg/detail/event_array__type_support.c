...
size_t stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__size_function__Event__events(
...
const void * stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__get_const_function__Event__events(
...
void * stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__get_function__Event__events(
...
bool stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__resize_function__Event__events(
...
static rosidl_typesupport_introspection_c__MessageMember stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__EventArray_message_member_array[4] = {
  ...
  },
  {
    ...
    NULL,  // default value
    stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__size_function__Event__events,  // size() function pointer
    stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__get_const_function__Event__events,  // get_const(index) function pointer
    stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__get_function__Event__events,  // get(index) function pointer
    stonefish_ros2__msg__EventArray__rosidl_typesupport_introspection_c__resize_function__Event__events  // resize(index) function pointer
  }
};
