...
{
  new (message_memory) stonefish_ros2::msg::DVLBeam(_init);
}

void DVLBeam_fini_function(void * message_memory)
{
  auto typed_message = static_cast<stonefish_ros2::msg::DVLBeam *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DVLBeam_message_member_array[5] = {
  {
    ...
    offsetof(stonefish_ros2::msg::DVLBeam, range),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(stonefish_ros2::msg::DVLBeam, range_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(stonefish_ros2::msg::DVLBeam, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(stonefish_ros2::msg::DVLBeam, velocity_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(stonefish_ros2::msg::DVLBeam, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DVLBeam_message_members = {
  ...
  5,  // number of fields
  sizeof(stonefish_ros2::msg::DVLBeam),
...
{
  return &::stonefish_ros2::msg::rosidl_typesupport_introspection_cpp::DVLBeam_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stonefish_ros2, msg, DVLBeam)() {
  return &::stonefish_ros2::msg::rosidl_typesupport_introspection_cpp::DVLBeam_message_type_support_handle;
}
